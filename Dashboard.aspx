...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="background-color:#bfb8b0">
        ...
        <table cellpadding="0" cellspacing="1" align="bottom" class="auto-style1">
            <tr>
                <td>
                    <asp:Button ID="btn_que" runat="server" Height="60px" Width="200px" Text="Ask Question" CssClass="grey" />
                </td>
                <td>
                    <asp:Button ID="btn_ans" runat="server" Height="60px" Width="200px" Text="View Answers" CssClass="grey" />
                </td>
                <td>
